***PLOC***ms.ContentId: C49DA0E6-2E12-4D51-803A-31B1B5A8F85C
title: PowerShell Reference***PLOC***

#***PLOC***PowerShell for Containers***PLOC***

##***PLOC***Install-ContainerOSImage***PLOC***

*****PLOC***NAME***PLOC********PLOC***      
Install-ContainerOSImage***PLOC***

*****PLOC***SYNOPSIS***PLOC********PLOC***  
Installs the given WIM as a container OS image for use with Windows Server or Hyper-V Containers.***PLOC***

*****PLOC***SYNTAX***PLOC********PLOC***  
``` PowerShell  
Install-ContainerOSImage [-WimPath] <String> ***PLOC***[***PLOC***-Force***PLOC***][< commonparameters >]
...
*****PLOC***INPUTS***PLOC********PLOC***      
None***PLOC***

*****PLOC***OUTPUTS***PLOC********PLOC***  
None***PLOC***

*****PLOC***ALIASES***PLOC********PLOC***  
None***PLOC***

***PLOC***-------------------------- EXAMPLE 1 --------------------------***PLOC***

***PLOC***``` PowerShell
PS C:\>Install-ContainerOSImage c:\baseimage.wim***PLOC***
...
*****PLOC***PARAMETERS***PLOC********PLOC***  
``` PowerShell
    -ContainerImage <Object>***PLOC***
...
*****PLOC***INPUTS***PLOC********PLOC***  
Microsoft.Containers.PowerShell.Objects.ContainerImage***PLOC***

*****PLOC***OUTPUTS***PLOC********PLOC***  
Microsoft.Containers.PowerShell.Objects.ContainerImageReport***PLOC***
